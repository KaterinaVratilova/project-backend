...
import com.example.etorobackend.auth.filters.JwtFilter;
import com.example.etorobackend.users.services.CustomUserDetailsService;
...
public class SecurityConfiguration {
    ...
    @Autowired
    public SecurityConfiguration(CustomUserDetailsService userService, JwtFilter jwtFilter, PasswordEncoder passwordEncoder) {
